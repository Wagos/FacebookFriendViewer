...
public class PhotoFlipActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        long id = getIntent().getLongExtra("albumId", -1);
        int position = getIntent().getIntExtra("position", -1);
        flipView = new FlipViewController(this);
        flipView.setAdapter(new PhotoCursorAdapter(this,
                getDbService().getPhotoCursor(Long.toString(id)),
                R.layout.photo_flip), position);
